...
description: Use when running, configuring, or troubleshooting the claude-code-website-builder Riela package for SolidJS/Bun website generation, Docker-contained Bun execution, Playwright review, git snapshot commits, pinned website dependencies, and Telegram/Discord/webhook feedback events.
---
...
```bash
riela workflow run claude-code-website-builder --input-json '{
...
`.riela/workflows/claude-code-website-builder/containers/bun-site-runner/Containerfile`,
...
cp -R .riela/workflows/claude-code-website-builder/event-templates/.riela-events/* .riela-events/
```
