...
```bash
riela package install claude-code-impl-plan-completion-review-loop --source /path/to/riela-packages/packages/claude-code-impl-plan-completion-review-loop
```
