...
- Package id: `claude-code-recent-change-quality-loop`
- Backends: `claude-code-agent`
- Workflows: `claude-code-recent-change-quality-loop`
...
```bash
riela workflow inspect claude-code-recent-change-quality-loop --output json
riela workflow validate claude-code-recent-change-quality-loop
riela workflow run claude-code-recent-change-quality-loop --output jsonl
```
