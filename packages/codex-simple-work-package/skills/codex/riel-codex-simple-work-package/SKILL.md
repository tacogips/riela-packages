...
```bash
bun run packages/rielflow/src/bin.ts workflow run codex-simple-work-package \
...
```bash
bun run packages/rielflow/src/bin.ts workflow validate codex-simple-work-package \
