...
- Codex `gpt-6-luna` medium effort: implementation, revisions, and overwrite repair
- Codex `gpt-6-sol` medium effort: design, plan, test-integrity, and the single adversarial implementation review
