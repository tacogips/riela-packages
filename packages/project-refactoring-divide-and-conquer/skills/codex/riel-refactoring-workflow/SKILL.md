---
name: riel-refactoring-workflow
description: Use when planning, running, monitoring, or troubleshooting the packaged rielflow divide-and-conquer refactoring workflow. Applies to `refactoring-divide-and-conquer`, duplicate-scavenge refactoring, concurrent slice review via `refactoring-slice-review`, generated refactoring implementation plans, implementation/review loop handling, blocked verification, dependency-owned agent mocks, and final plan archival.
---

# Riel Refactoring Workflow
...
- Parent workflow: `refactoring-divide-and-conquer`
- Parent package id: `project-refactoring-divide-and-conquer`
- Child workflow: `refactoring-slice-review`
- Child package id: `project-refactoring-slice-review`
...
```bash
bun run packages/rielflow/src/bin.ts workflow package checkout project-refactoring-divide-and-conquer
bun run packages/rielflow/src/bin.ts workflow package checkout project-refactoring-slice-review
...
```bash
bun run packages/rielflow/src/bin.ts workflow validate refactoring-divide-and-conquer --output json
bun run packages/rielflow/src/bin.ts workflow validate refactoring-slice-review --output json
```
