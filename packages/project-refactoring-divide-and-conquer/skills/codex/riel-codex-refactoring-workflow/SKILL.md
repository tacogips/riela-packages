...
description: Use when planning, running, monitoring, or troubleshooting the packaged rielflow divide-and-conquer refactoring workflow. Applies to `codex-refactoring-divide-and-conquer`, duplicate-scavenge refactoring, concurrent slice review via `codex-refactoring-slice-review`, generated refactoring implementation plans, implementation/review loop handling, blocked verification, dependency-owned agent mocks, and final plan archival.
---
