...
```bash
riela package install claude-code-goal --source /path/to/riela-packages/packages/claude-code-goal
```
...
```bash
riela package install codex-goal --source /path/to/riela-packages/packages/codex-goal
```
