...
```bash
riela package install claude-code-simple-work-package --source /path/to/riela-packages/packages/claude-code-simple-work-package
```
...
```bash
riela package install codex-simple-work-package --source /path/to/riela-packages/packages/codex-simple-work-package
```
