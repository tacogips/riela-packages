...
```bash
bun run packages/rielflow/src/bin.ts workflow validate claude-code-refactoring-slice-review --workflow-definition-dir .rielflow/workflows
```
...
```bash
bun run packages/rielflow/src/bin.ts workflow run claude-code-refactoring-slice-review \
  --workflow-definition-dir .rielflow/workflows \
  --mock-scenario .rielflow/workflows/claude-code-refactoring-slice-review/mock-scenario.json \
  --output json
```
...
{
  "status": "completed",
  "workflowName": "claude-code-refactoring-slice-review",
  "workflowId": "claude-code-refactoring-slice-review",
  "nodeExecutions": 1,
  "transitions": 0,
  "exitCode": 0
}
