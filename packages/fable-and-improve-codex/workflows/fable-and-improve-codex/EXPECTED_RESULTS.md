...
Run workflow validate/inspect, then workflow run fable-and-improve-codex with its bundled mock-scenario.json, isolated --session-store and --artifact-root. Use the paired Riela source build. Mock calls do not invoke models, commit or push.
