...
5. `codex-implementation` implements with `gpt-5.6-terra`.
6. `codex-review` independently accepts with `gpt-5.6-sol` and
...
riela workflow run fable-and-improve-codex \
  --workflow-definition-dir <riela-packages-checkout>/packages/fable-and-improve-codex/workflows \
  --mock-scenario <riela-packages-checkout>/packages/fable-and-improve-codex/workflows/fable-and-improve-codex/mock-scenario.json \
  --variables '{"memoryRoot":"./tmp/fable-and-improve-codex/memory","noteRoot":"./tmp/fable-and-improve-codex/notes","workflowInput":{"requestedOutcome":"Add and verify the requested documentation note."}}' \
  --output json
```
