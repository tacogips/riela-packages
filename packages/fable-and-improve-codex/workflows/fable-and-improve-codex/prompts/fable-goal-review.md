...
implementation plan against the SOL implementation and independent Terra
...
- Set `needs_todo` when the Fable artifacts remain valid and SOL needs another concrete implementation pass.
