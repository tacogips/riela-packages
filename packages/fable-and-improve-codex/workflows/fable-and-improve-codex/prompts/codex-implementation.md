...
On a loop, address every actionable Terra review finding or Fable TODO.
...
- Review the changed diff for obvious omissions before returning, but leave independent acceptance review to the Terra review step.
