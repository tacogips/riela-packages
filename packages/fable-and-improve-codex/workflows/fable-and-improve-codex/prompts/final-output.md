...
plan artifacts, Terra implementation evidence, Terra review evidence, changed
...
Return JSON with `status`, `goalAchieved`, `analysisMarkdown`, `designMarkdown`,
`planMarkdown`, `designDocPaths`, `implPlanPaths`, `changedFiles`,
`implementationEvidence`, `reviewEvidence`, `verificationEvidence`,
