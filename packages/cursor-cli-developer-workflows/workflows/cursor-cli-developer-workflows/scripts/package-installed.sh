...
cat >"$output_path" <<'JSON'
{
  "payload": {
    "status": "ready",
    "message": "Install this package to add the Cursor CLI developer workflow dispatcher rule and the standard Cursor CLI developer workflow packages.",
    "skills": [
      "cursor:riel-cursor-cli-developer-workflows"
    ],
    "packages": [
