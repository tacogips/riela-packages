...
description: Use when planning, running, monitoring, or troubleshooting the packaged riela divide-and-conquer refactoring workflow. Applies to `codex-refactoring-divide-and-conquer`, duplicate-scavenge refactoring, concurrent slice review via `codex-refactoring-slice-review`, generated refactoring implementation plans, implementation/review loop handling, blocked verification, dependency-owned agent mocks, and final plan archival.
---
...
- Parent workflow: `codex-refactoring-divide-and-conquer`
- Parent package id: `codex-refactoring-divide-and-conquer`
- Child workflow: `codex-refactoring-slice-review`
- Child package id: `codex-refactoring-slice-review`
...
```bash
riela workflow package checkout codex-refactoring-divide-and-conquer
riela workflow package checkout codex-refactoring-slice-review
riela workflow run codex-refactoring-divide-and-conquer \
...
Keep this as a mode of `codex-refactoring-divide-and-conquer`; do not create or run a
...
- `codex-refactoring-slice-review` owns per-slice duplicate evidence.
...
3. Fan out concurrent child `codex-refactoring-slice-review` runs.
...
```bash
riela workflow validate codex-refactoring-divide-and-conquer --output json
riela workflow validate codex-refactoring-slice-review --output json
```
