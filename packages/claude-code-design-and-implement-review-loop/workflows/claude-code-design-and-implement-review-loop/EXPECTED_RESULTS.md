...
```bash
nix run ./rielflow -- workflow validate claude-code-design-and-implement-review-loop
```
...
```bash
nix run ./rielflow -- workflow run claude-code-design-and-implement-review-loop \
  --mock-scenario .rielflow/workflows/claude-code-design-and-implement-review-loop/mock-scenario.json \
  --output json
```
...
{
  "status": "completed",
  "workflowName": "claude-code-design-and-implement-review-loop",
...
```bash
nix run ./rielflow -- workflow run claude-code-design-and-implement-review-loop \
  --mock-scenario .rielflow/workflows/claude-code-design-and-implement-review-loop/mock-scenario-planning-only.json \
  --output json
```
...
```json
{
  ...
  "designDocPaths": [
    "design-docs/specs/design-claude-code-reference-session-history.md"
  ],
  "implPlanPaths": ["impl-plans/active/claude-code-reference-session-history.md"],
  "claudeCodeAgentReferences": [
    "../../claude-code-agent/src/session",
    "../../claude-code-agent/src/cli"
  ],
  "designReviewSummary": "Design accepted after Cursor adapter boundaries and claude-code-agent divergence were clarified.",
  ...
  "commitMessage": "docs: add claude-code-reference session history design and plan",
  "commitHash": "fedcba9876543210fedcba9876543210fedcba98",
  "pushedRemote": "origin",
  "pushedBranch": "main",
  "nextStep": "Run a full issue-resolution execution for impl-plans/active/claude-code-reference-session-history.md when implementation is approved.",
  "residualRisks": []
}
```
