...
- When Claude Code reference input is present, keep Cursor-specific behavior isolated behind adapter modules and explain any intentional divergence from the reference behavior.
- Prefer the local reference repository at `../../claude-code-agent` unless Step 1 established a different local root.
