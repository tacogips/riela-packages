...
```bash
bun run packages/rielflow/src/bin.ts workflow package checkout claude-code-design-and-implement-review-loop
bun run packages/rielflow/src/bin.ts workflow run claude-code-design-and-implement-review-loop --output json
```
