...
Read the result delivered from the cross-workflow call to `claude-code-design-and-implement-review-loop`, plus the Step 2 handoff payload that selected the active implementation plan.
