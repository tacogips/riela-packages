...
```bash
riela package install cursor-cli-hydra-codex-design-and-implement-review-loop --source /path/to/riela-packages/packages/cursor-cli-hydra-codex-design-and-implement-review-loop
```
