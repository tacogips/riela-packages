...
- The plan has clear handling for any recommended Rielflow workflow delegation.
- The plan shows active investigation of available Rielflow workflows and does not skip a better dedicated workflow without a recorded reason.
- If a specialized Rielflow workflow is a better fit than generic work, the plan names the workflow id, dispatch input, lookup assumptions, and how to interpret the delegated result.
