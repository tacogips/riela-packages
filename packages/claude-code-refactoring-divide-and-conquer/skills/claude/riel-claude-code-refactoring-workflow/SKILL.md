...
```bash
rielflow workflow package checkout claude-code-refactoring-divide-and-conquer
rielflow workflow package checkout claude-code-refactoring-slice-review
rielflow workflow run claude-code-refactoring-divide-and-conquer \
...
```bash
rielflow workflow validate claude-code-refactoring-divide-and-conquer --output json
rielflow workflow validate claude-code-refactoring-slice-review --output json
```
