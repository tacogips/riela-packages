...
description: Use when planning, running, monitoring, or troubleshooting the packaged rielflow divide-and-conquer refactoring workflow. Applies to `claude-code-refactoring-divide-and-conquer`, duplicate-scavenge refactoring, concurrent slice review via `claude-code-refactoring-slice-review`, generated refactoring implementation plans, implementation/review loop handling, blocked verification, dependency-owned agent mocks, and final plan archival.
---
...
```bash
bun run packages/rielflow/src/bin.ts workflow package checkout claude-code-refactoring-divide-and-conquer
bun run packages/rielflow/src/bin.ts workflow package checkout claude-code-refactoring-slice-review
bun run packages/rielflow/src/bin.ts workflow run claude-code-refactoring-divide-and-conquer \
...
```bash
bun run packages/rielflow/src/bin.ts workflow validate claude-code-refactoring-divide-and-conquer --output json
bun run packages/rielflow/src/bin.ts workflow validate claude-code-refactoring-slice-review --output json
```
