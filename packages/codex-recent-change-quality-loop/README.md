...
- Workflows: `codex-recent-change-quality-loop`
...
```bash
riela workflow inspect codex-recent-change-quality-loop --output json
riela workflow validate codex-recent-change-quality-loop
riela workflow run codex-recent-change-quality-loop --output jsonl
```
