...
description: Use when running, configuring, or troubleshooting the codex-website-builder Rielflow package for SolidJS/Bun website generation, Docker-contained Bun execution, Playwright review, git snapshot commits, pinned website dependencies, and Telegram/Discord/webhook feedback events.
---
...
```bash
rielflow workflow run codex-website-builder --input-json '{
...
`.rielflow/workflows/codex-website-builder/containers/bun-site-runner/Containerfile`,
...
cp -R .rielflow/workflows/codex-website-builder/event-templates/.rielflow-events/* .rielflow-events/
```
