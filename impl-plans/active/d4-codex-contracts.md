...
Run from repository root, assigning E to the absolute runtime evidenceRoot/d4-codex-contracts/attempt-N path and creating it before execution. Capture each command separately with its true exit; do not mask failure with tee.
