...
Start only after d4-opus-contracts and d4-codex-contracts have finished and their source-matched native branch outputs have joined. All writers must have stopped. Independent review acceptance is a final-publication gate, not a prerequisite for starting reconciliation or preparing its review handoff. This plan is the sole owner of manifests and generated index. Its sharedPaths permit scoped lost-edit/contract repairs in the two completed bundles, not unrelated changes. Never modify another worker's progress log.
...
5. Prepare exact reviewed-file and verification handoff for test-integrity, Sol adversarial and Astra integration review. Record each accept/revise decision against exact source hashes; resolve high/mid findings and renew affected evidence/review after material repairs. The effective input already resolves scope to the two bundles; do not reopen the third-package question. No unresolved material finding may be described as accepted. Review acceptance and final Git operations belong to later owning workflow steps.
...
- Both required upstream plan deliverables and their source-matched evidence survive in the joined tree. Reconciliation completes its assigned checks and prepares the independent review handoff; review acceptance remains required before final publication.
...
- Test-integrity, Sol adversarial and Astra integration review have explicit acceptance with no unresolved high/mid finding before final commit/push.
